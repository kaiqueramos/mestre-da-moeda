...
function Contato({ globalData }) {
    const schemaData = {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 2,
            name: 'Contato',
            item: `${globalData.canonicalUrl}/contato`,
          },
        ],
      };
    ...
    return (
        <Layout>
            <SEO 
                title={`Contato - ${globalData.name}`}
                description="Entre em contato com o Mestre da Moeda para dúvidas, sugestões ou propostas."
                canonicalUrl={`${globalData.canonicalUrl}/contato`}
