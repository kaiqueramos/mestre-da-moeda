...
function DeclaracaoAfiliados({ globalData }) {
    const schemaData = {
        ...
        itemListElement: [
          ...
          },
          {
            '@type': 'ListItem',
            position: 2,
            name: 'Declaração de Afiliados',
            item: `${globalData.canonicalUrl}/declaracao-de-afiliados`,
          },
        ],
      };
    ...
    return (
        <Layout>
            <SEO 
                title={`Declaração de Afiliados - ${globalData.name}`}
                description="Entenda como funciona nosso programa de afiliados e nossa política de transparência."
                canonicalUrl={`${globalData.canonicalUrl}/declaracao-de-afiliados`}
